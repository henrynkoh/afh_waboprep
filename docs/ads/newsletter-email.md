...
- AFH permit prep: Entry Mode → 2D/3D drawing → packet (Lewis, Thurston, Pierce WA)  
- How to get your AFH building inspection passed — one app, one flow  
- Single-family → 6-bed AFH: data, drawings, and permit packet in one place  

**Preview text (50–90 chars):**  
Turn a single-family home in WA into a WABO-ready AFH. Entry Mode, 2D/3D drawing, permit packet.
...
3. **Pipeline** — Use AI-agent prompts (Compliance, Design, Permit Ops, Red-Team) with Moltbot/Clawdbot or any AI runner.
4. **Centralia Packet** — Required submittal list and document names for City of Centralia and Lewis County.
5. **Curriculum & Top 100 Q&A** — 8-week consultant outline and WAC/DSHS 15-604 Q&A.

**Case study:** 2606 Cooks Hill Rd, Centralia 98531 — same flow for any address.

**Quick start:**  
[YOUR_CTA]: [YOUR_URL]

Manual & tutorial: [YOUR_URL] (see README, QUICKSTART, docs/MANUAL, docs/TUTORIAL).

— [YOUR_NAME]

---
[UNSUBSCRIBE_LINK] | [Privacy] | [Contact]
---

---

## Promotional email (short)
...
- **Pipeline** — AI prompts (Compliance, Design, Permit Ops, Red-Team).  
- **Centralia Packet** — Submittal list and doc names.  
- **Curriculum & Top 100 Q&A** — Inspection prep.

**Start here:** [YOUR_CTA] → [YOUR_URL]
...
- [ ] Comply with CAN-SPAM / GDPR (unsubscribe, sender address, etc.)
